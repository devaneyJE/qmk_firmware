...
[_CDH] = LAYOUT(
  ...
  MT(MOD_LSFT, KC_Z),    KC_X,    KC_C,    KC_D,    KC_V,         KC_K,    KC_H,    KC_COMM, KC_DOT,  MT(MOD_LSFT, KC_SLSH),
  KC_1, KC_NO, LT(3,KC_DEL), LT(1,KC_BSPC), KC_2,         KC_3, LT(2,KC_SPC), KC_ENT, QK_REP, KC_4
),
